...
const products: Product[] = [
  {
    id: 1,
    name: "Summer Set Short",
    price: 199.99,
    originalPrice: 249.99,
    rating: 4.8,
    reviews: 124,
    image: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/26/5569004/1.jpg?3444",
    badge: "Sale",
    quantity: 1
  },
  {
    id: 2,
    name: "Summer short sleeved",
    price: 299.99,
    rating: 4.6,
    reviews: 89,
    image: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/12/4995814/1.jpg?9512",
    isNew: true,
    quantity: 1
  },
  {
    id: 3,
    name: "2-in-1 shirt & short",
    price: 79.99,
    originalPrice: 99.99,
    rating: 4.9,
    reviews: 156,
    image: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/86/8156804/1.jpg?0229",
    badge: "Popular",
    quantity: 1
  },
  {
    id: 4,
    name: "Sport Cloth Set",
    price: 49.99,
    rating: 4.4,
    reviews: 67,
    image: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/35/6994463/1.jpg?1564",
    quantity: 1
  },
  {
    id: 5,
    ...
    rating: 4.7,
    reviews: 203,
    image: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/68/7922463/1.jpg?8821",
    badge: "Sale",
    quantity: 1
  },
  {
    id: 6,
    name: "T-Shirt Two-Piece Set",
    price: 89.99,
    rating: 4.5,
    reviews: 45,
    image: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/29/2015804/1.jpg?0257",
    isNew: true,
    quantity: 1
  },
  {
    id: 7,
    name: "Pure Cotton Printed Set",
    price: 24.99,
    rating: 4.3,
    reviews: 78,
    image: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/17/6902704/1.jpg?6163",
    quantity: 1
  },
  {
    id: 8,
    name: "Basket 2-in-1 Shirt & Short",
    price: 59.99,
    originalPrice: 79.99,
    rating: 4.6,
    reviews: 134,
    image: "https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/64/6401804/1.jpg?0423",
    badge: "Sale",
    quantity: 1
  },
]

export function ClothForBabyGirl() {
